...
const ProjectCard = ({
  ...
  return (
    <Link href={link} className={thm`p-5 md:p-6 $bg-accent-4 dark:$bg-accent-4 rounded-3xl h-52 w-full max-w-sm overflow-hidden mx-auto flex flex-col justify-end hover:shadow-md transition-shadow duration-500`}>
      <div className="pb-1">
