...
bool isKeyword(char *str) {
    if (!strcmp(str, "if") || !strcmp(str, "else") ||
        ...
        !strcmp(str, "float") || !strcmp(str, "return") || !strcmp(str, "char") || !strcmp(str, "case") || !strcmp(str, "char") || !strcmp(str, "sizeof") || !strcmp(str, "long") ||
            ...
            if (isDelimiter(str[right]) == true && left == right) {
                ...
                if (strcmp(subStr, "")) {
                    ...
                    if (isKeyword(subStr) == true)
                        ...
                        fprintf(fcode, "'%s' IS NOT A VALID IDENTIFIER BECAUSE IT STARTS WITH A NUMBER.\n", subStr);
                    left = right;
                }
            }
        }
